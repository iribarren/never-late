 ...
 *
 * The [UserPreferencesRepository] is created once here (manual dependency injection — no
 * framework needed for a project this size) and threaded down into [AppNavHost], which passes
 * it to whichever screen needs it via [com.neverlate.ui.navigation.AppViewModelFactory].
 */
