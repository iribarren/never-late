 ...
 * badge). Modeled as a sealed hierarchy, same reasoning as
 * [com.neverlate.data.articles.RefreshResult], so the UI can render a distinct (localized) hint
 * for each case instead of a single boolean.
 */
